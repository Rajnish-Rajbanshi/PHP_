...
<head>
    ...
    <title>WAP to find smallest among three numbers.</title>
</head>
<body>
    <form action="" method="post"> // action is empty because we want to submit the form to the same page.
        ...
        if($num1==$num2 && $num2==$num3){
            echo"<h3>All are equal numbers</h3>";
                ...
                echo"<h3>$num2 is the smallest number.</h3>";
                 ...
                 echo"<h3>$num3 is the smallest number.</h3>";
        } else{
